...
class CreateRoteiroComponent extends Component {
    constructor(props) {
        super(props)
        ...
        this.saveRoteiro = this.saveRoteiro.bind(this);
    ...
    saveRoteiro = (e) => {
        ...
        RoteiroService.createRoteiro(roteiro).then(res => {
                        ...
                        <div className="col-md-6 offset-md-3 offset-md-3">
                            ...
                            <div className="card-body">
                                <form className="border1">
                                    ...
                                    <button className="btn btn-success" onClick={this.saveRoteiro}>Confirmar</button>
...
export default CreateRoteiroComponent
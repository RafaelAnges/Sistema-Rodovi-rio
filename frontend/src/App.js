...
//function App() {
 ...
 //       <div >
  ...
  //          <Route path="/menu" component={MenuComponent} />
     //       <Route path="/add-roteiro" component={CreateRoteiroComponent} />
    //        <Route path="/roteiros" component={ListRoteiroComponent} />
    //        <Route path="/passagens" component={ListPassagemComponent} />
    //        <Route path="/add-passagem" component={CreatePassagemComponent} />

    //      </Switch>
          //<Switch>
    //        <Route path="/cidade" component={ListCidadeComponent} />
  ...
  //          <Route path="/add-cidade" component={CreateCidadeComponent} />
   //         <Route path="/update-cidade/:id" component={UpdateCidadeComponent} />
    ...
    //      <Switch>
    //        <Route path="/veiculo" component={ListVeiculoComponent} />

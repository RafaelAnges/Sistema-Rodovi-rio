...
create table tb_passagem (id int8 generated by default as identity, cidade_destino_p varchar(255), cidade_origem_p varchar(255), data_saida_p date, hora_saida_p time, poltrona_p int4, valor_p float8, veiculo_p varchar(255), primary key (id));
